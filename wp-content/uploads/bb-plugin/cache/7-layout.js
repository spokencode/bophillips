...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var hash=window.location.hash.replace('#','').split('/').shift(),element=null,tabs=null,responsiveLabel=null,tabIndex=null,label=null;console.log(hash);if(''!=hash){element=$('#'+hash);if(element.length>0){if(element.hasClass('fl-accordion-item')){setTimeout(function(){element.find('.fl-accordion-button').trigger('click');},100);}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){var FLAccordion={init:function()
{$('.fl-accordion-button').off('click');$('.fl-accordion-button').click(FLAccordion._buttonClick);},_buttonClick:function()
...
{var item=$(this).parent(),win=$(window);if(item.offset().top<win.scrollTop()+100){$('html, body').animate({scrollTop:item.offset().top-100},500,'swing');}}};$(FLAccordion.init);})(jQuery);var wpAjaxUrl='http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://preview.pgsrv9o5mictbj4ikid4vvh1zths38frxmuznpmta3ot7qfr.box.codeanywhere.com/wp-content/plugins/bb-plugin/';